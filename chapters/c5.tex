...
\begin{lstlisting}[title={Exercise A - Alt Tab Implementation}, language=Python, captionpos=b]
...
\begin{lstlisting}[title={Exercise B - Screenshot Automation Implementation}, language=Python, captionpos=b]
import pyautogui
import time
...
This approach allows the software to take a screenshot and immediately transition back to gesture control, fulfilling the exercise requirements while keeping the application smooth and responsive.